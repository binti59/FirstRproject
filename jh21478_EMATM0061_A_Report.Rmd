...
finance_data%>%filter(state %in% c("Louisiana","Montana","Mississippi","Kentucky"))%>%ggplot(aes(x=year,y=totals_revenue))+xlab("Year")+theme_bw()+ylab("Revenue")+geom_smooth(method='lm')+geom_point()
